...
public class DriveBase extends Subsystem {
    ...
    public double driveCurve(double percentDone) {
    	if(percentDone<ACCELERATION_ZONE)//if were supposed to be accelerating up
    		...
    		return TOP_SPEED*(percentDone-1)*(percentDone-1) / (ACCELERATION_ZONE * ACCELERATION_ZONE);//return value of formula FLIPPED ACROSS Y AXIS, so that we are deceleration, not accelerating a lot
    	else
