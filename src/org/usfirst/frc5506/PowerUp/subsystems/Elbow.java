...
public class Elbow extends Subsystem {
    ...
    public void periodic() {
    	...
    	if(foreLS.get()&&elbowSpeed<0)//front limit switch triggered, and trying to push down
    		elbow.set(0);								//stop the motor!
    	
    	if(rearLS.get()&&elbowSpeed>0)//rear limit switch triggered, and trying to push up
