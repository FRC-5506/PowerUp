...
public class RobotMap {
    ...
    public static void init() {
        ...
        armPos = new Encoder(0, 1, false, EncodingType.k4X);
        leftRevs = new Encoder(2, 3, false, EncodingType.k4X);
        rightRevs = new Encoder(4, 5, false, EncodingType.k4X);
        
        LiveWindow.addSensor("Arm", "Position", armPos);
        //Don't use this method yet, find out how many pulses it will give for a
        //certain distance, then convert that into something useful like degrees or feet
        //using an inverse//armPos.setDistancePerPulse();
