...
public class RobotMap {
    ...
    public static WPI_VictorSPX leftMaster;
    public static WPI_VictorSPX rightMaster;
	...
	public static void init() {
        ...
        leftMaster = new WPI_VictorSPX(4);
        ...
        armPos = new Encoder(4, 5, false, EncodingType.k4X);//1 unit should be 1 deg
        leftRevs = new Encoder(0, 1, true, EncodingType.k4X);
        rightRevs = new Encoder(2, 3, false, EncodingType.k4X);
        
        leftRevs.setDistancePerPulse(6*Math.PI*10/2332);//pulses for 10 wheel rotations
        rightRevs.setDistancePerPulse(6*Math.PI*10/2497);//MAKE SURE TO DO EACH WHEEL SEPARATE THEYRE DIFFERENT
        ...
        foreLS = new DigitalInput(7);
        rearLS = new DigitalInput(6);
        
        LiveWindow.addSensor("Arm", "Position", armPos);
        armPos.setDistancePerPulse(90/73);//90deg per 73 pulses
